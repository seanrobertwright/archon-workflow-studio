---
name: 'source-command-content-ideation-youtube'
description: 'Generate YouTube scripts from Content Engine + daily notes + web research'
---

# source-command-content-ideation-youtube

Use this skill when the user asks to run the migrated source command `content-ideation-youtube`.
...
```
.Codex/skills/yt-script/SKILL.md
.Codex/skills/yt-script/references/style-guide.md
```
