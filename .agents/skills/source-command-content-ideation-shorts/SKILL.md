---
name: 'source-command-content-ideation-shorts'
description: 'Generate YouTube Shorts scripts from Content Engine + daily notes + web research'
---

# source-command-content-ideation-shorts

Use this skill when the user asks to run the migrated source command `content-ideation-shorts`.
...
```
.Codex/skills/yt-shorts/SKILL.md
```
...
Read `.Codex/skills/yt-shorts/SKILL.md` to understand:
