---
name: 'source-command-content-ideation-linkedin'
description: 'Generate LinkedIn posts from Content Engine + daily notes + web research'
---

# source-command-content-ideation-linkedin

Use this skill when the user asks to run the migrated source command `content-ideation-linkedin`.
...
.Codex/skills/linkedin-post/references/style-guide.md
```
