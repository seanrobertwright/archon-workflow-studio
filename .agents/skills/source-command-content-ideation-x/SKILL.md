---
name: 'source-command-content-ideation-x'
description: 'Generate X posts/threads from Content Engine + daily notes + web research'
---

# source-command-content-ideation-x

Use this skill when the user asks to run the migrated source command `content-ideation-x`.
...
```
.Codex/skills/x-post/SKILL.md
.Codex/skills/x-post/references/templates.md
```
